...
def main():
    ...
    context = {
        "data_to_process": {
            ...
            1: {
                "crop": [{"x": 350, "y": 430}, {"x": 692, "y": 754}],
                "positive": [{"x": 534, "y": 603}],
                "negative": [],
                "image_hash": "YZKQrZH5C09u5m30Bz8GeYs=",
            },
            2: {
                "crop": [{"x": 698, "y": 365}, {"x": 1048, "y": 623}],
                "positive": [{"x": 873, "y": 494}],
                "negative": [],
                "image_hash": "YZKQrZH5C0rBvGGA3p7hjWahz3/pV09u5m30Bz8GeYs=",
            },
            3: {
                "crop": [{"x": 509, "y": 180}, {"x": 968, "y": 463}],
    ...
    response = api.task.send_request(
        task_id, "smart_segmentation_batched", data={}, context=context, timeout=60
    )
