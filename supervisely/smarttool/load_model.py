...
def deploy(model_name):
    available_models = {
        ...
        "static_resnet50_deeplab_chest_xray": (
            "https://github.com/supervisely-ecosystem/PaddleSeg/releases/download/v2.3.4/static_resnet50_deeplab_chest_xray.pdiparams",
            "https://github.com/supervisely-ecosystem/PaddleSeg/releases/download/v2.3.4/static_resnet50_deeplab_chest_xray.pdmodel",
        ),
        "static_resnet18_deeplab_chest_xray": (
            "https://github.com/supervisely-ecosystem/PaddleSeg/releases/download/v2.3.4/static_resnet18_deeplab_chest_xray.pdiparams",
            "https://github.com/supervisely-ecosystem/PaddleSeg/releases/download/v2.3.4/static_resnet18_deeplab_chest_xray.pdmodel",
        ),
        "static_hrnet18s_ocr48_MRSpineSeg": (
            "https://github.com/supervisely-ecosystem/PaddleSeg/releases/download/v2.3.4/static_hrnet18s_ocr48_MRSpineSeg.pdiparams",
            "https://github.com/supervisely-ecosystem/PaddleSeg/releases/download/v2.3.4/static_hrnet18s_ocr48_MRSpineSeg.pdmodel",
        ),
        "static_hrnet18s_ocr48_aluminium": (
            "https://github.com/supervisely-ecosystem/PaddleSeg/releases/download/v2.3.4/static_hrnet18s_ocr48_aluminium.pdiparams",
            "https://github.com/supervisely-ecosystem/PaddleSeg/releases/download/v2.3.4/static_hrnet18s_ocr48_aluminium.pdmodel",
        ),
    ...
    with_mask = model_name != "static_edgeflow_cocolvis"
    predictor_params = {
        "brs_mode": "NoBRS",
        "with_flip": False,
        "zoom_in_params": {
